...
spfirstVer =  'Revision: 3.1 28-May-2009';
...
% Refresh display by panning axis forward and back so n label isn't duplicated
set(h.Axis.Big, 'XLim', [XLim(1) + 1, XLim(2) + 1]);
set(h.Axis.Big, 'XLim', [XLim(1), XLim(2)]);
