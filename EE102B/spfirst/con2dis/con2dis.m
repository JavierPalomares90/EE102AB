...
%globals
Ver = 'CON2DIS ver. 2.1';   % Version string for figure title
...
switch action
    ...
    case 'Initialize'
        ...
        guidata(gcf,h);
        set(gcf,'HandleVisibility','callback','vis','on'); % Make figure inaccessible from command line  
