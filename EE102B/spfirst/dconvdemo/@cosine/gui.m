...
%GUI Create and manage the graphic controls for COSINE object
%   GUI(Signal, Pos) creates the controls in the rectangle of the current
%   figure described by Pos to let the user interactively change the COSINE
...
%   UserData property holds a COSINE object.
%
...
%     stores the COSINE data in the UserData property of the plot.
%
%     GUI('Rescale Plot') rescales the x and y axis of the plot to fit the data.
%
%   See also SIGGENDLG, COSINE
